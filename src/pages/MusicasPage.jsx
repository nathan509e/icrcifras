...
export default function MusicasPage() {
  ...
  return (
    <div className="page-wrapper">
      ...
      {showLoginModal && (
        <div className="modal-overlay" onClick={() => { setShowLoginModal(false); setShowSignupForm(false) }}>
            ...
            {!showSignupForm ? (
              <>
                ...
                <p className="modal-login-desc">
                  ...
                  Faca login com sua conta Google ou crie uma conta para acessar e gerenciar as cifras.
                </p>
              ...
              <>
                ...
                <p className="modal-login-desc">
                  Crie uma conta para acessar as cifras da Igreja Caminho da Restauracao.
                </p>
                <div className="modal-body">
                ...
                <div className="modal-actions">
                  <button className="modal-btn modal-btn-cancel" onClick={() => { setShowSignupForm(false); setSignupError('') }}>Voltar</button>
                  <button
                    ...
                    onClick={async () => {
                      ...
                      setSignupError('')
                      try {
                        const { createUser, signInWithEmail } = await import('../supabase')
